...
function DialogContent({
  ...
  return (
    <DialogPortal data-slot="dialog-portal">
      ...
      <div
        className={cn(
          'fixed top-[50%] left-[50%] w-full max-w-[calc(100%-2rem)] sm:max-w-lg z-50',
        )}
      ...
      >
        <DialogPrimitive.Content
          ...
          className={cn(
            'bg-background data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:fade-out-0 data-[state=open]:fade-in-0 data-[state=closed]:zoom-out-95 data-[state=open]:zoom-in-95 grid gap-4 rounded-lg border p-6 shadow-lg duration-200',
            className,
          )}
          {...props}
        >
