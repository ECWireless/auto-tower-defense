...
library SavedKingdom {
  ...
  // Hex-encoded value schema of (address, uint256, uint256, uint256, bytes32[])
  Schema constant _valueSchema = Schema.wrap(0x00740401611f1f1fc10000000000000000000000000000000000000000000000);
  ...
  function getFieldNames() internal pure returns (string[] memory fieldNames) {
    ...
    fieldNames[3] = "winStreak";
    fieldNames[4] = "actions";
  }
  ...
  /**
   * @notice Get winStreak.
   */
  function getWinStreak(bytes32 id) internal view returns (uint256 winStreak) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
   ...
   * @notice Get winStreak.
   */
  function _getWinStreak(bytes32 id) internal view returns (uint256 winStreak) {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;
  ...
  /**
   * @notice Set winStreak.
   */
  function setWinStreak(bytes32 id, uint256 winStreak) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;

    StoreSwitch.setStaticField(_tableId, _keyTuple, 3, abi.encodePacked((winStreak)), _fieldLayout);
  }

  /**
   * @notice Set winStreak.
   */
  function _setWinStreak(bytes32 id, uint256 winStreak) internal {
    bytes32[] memory _keyTuple = new bytes32[](1);
    _keyTuple[0] = id;

    StoreCore.setStaticField(_tableId, _keyTuple, 3, abi.encodePacked((winStreak)), _fieldLayout);
  }
  ...
  function set(
    ...
    bytes memory _staticData = encodeStatic(author, electricitybalance, timestamp, winStreak);
  ...
  function decodeStatic(
    bytes memory _blob
  ) internal pure returns (address author, uint256 electricitybalance, uint256 timestamp, uint256 winStreak) {
    ...
    winStreak = (uint256(Bytes.getBytes32(_blob, 84)));
  }
  ...
  function decode(
    ...
    (_table.author, _table.electricitybalance, _table.timestamp, _table.winStreak) = decodeStatic(_staticData);
  ...
  function encodeStatic(
    ...
    return abi.encodePacked(author, electricitybalance, timestamp, winStreak);
  }
