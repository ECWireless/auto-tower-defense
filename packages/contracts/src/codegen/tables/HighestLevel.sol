...
library HighestLevel {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "HighestLevel", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626170700000000000000000000000486967686573744c6576656c00000000);
