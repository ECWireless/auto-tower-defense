...
library PlayerCount {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "PlayerCount", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626170700000000000000000000000506c61796572436f756e740000000000);
