...
library PlayerIdToAddress {
  // Hex below is the result of `WorldResourceIdLib.encode({ namespace: "app", name: "PlayerIdToAddres", typeId: RESOURCE_TABLE });`
  ResourceId constant _tableId = ResourceId.wrap(0x74626170700000000000000000000000506c617965724964546f416464726573);
