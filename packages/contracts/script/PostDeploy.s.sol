...
contract PostDeploy is Script {
  function run(address worldAddress) external {
    ...
    string memory sourceCode = "contract DefaultProjectileLogic { function getNextProjectilePosition( int16 x, int16 y ) public pure returns (int16, int16) { return (x + 5, y); } }";
